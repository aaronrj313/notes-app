  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-4 pb-24">
      <div className="bg-popover relative flex w-full max-w-sm flex-col items-center rounded-lg border p-8">
        ...
        <form className={`flex w-full flex-col gap-4 ${isPending && "-z-10 opacity-0"}`} action={handleClickCreateAccountButton}>
          ...
          <p className="mt-3 text-center text-xs">
            ...
            <Link href="/login" className="ml-2 underline transition-colors duration-200 ease-in-out">Login</Link>
          </p>
        </form>
      </div>
